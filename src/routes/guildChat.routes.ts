...
import { listMessages, messagesHead, postMessage, deleteMessage } from "../controllers/guildChat.controller";
...
//
// /:id/messages/head registers before /:id/messages/:messageId. DELETE is a
// different verb, so there is no live collision today — the ordering is kept
// specific-before-param so adding any other verb to the :messageId route can't
// swallow "head" as a message id.
